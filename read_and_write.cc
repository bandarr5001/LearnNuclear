...
int write_array(int iMAX, double *array1, double *array2) { //Writes the array into a file
    ...
    for(int count = 0; count < iMAX; count += 1) {
        //cout << "count before cycle:" << count << endl;
        outputFile << array1[count] << " " << array2[count] << std::endl; //Writes array and array2 at position count to the file
        //cout << count+ii << " " << array1[count+ii] << endl;
        //cout << "count after cycle:" << count << endl;
    }
